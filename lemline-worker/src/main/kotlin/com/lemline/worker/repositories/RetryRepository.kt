 ...
 * - Ordered processing based on retry timestamps
...
class RetryRepository : OutboxRepository<RetryModel> {
     ...
     * 2. Have reached their scheduled retry time
