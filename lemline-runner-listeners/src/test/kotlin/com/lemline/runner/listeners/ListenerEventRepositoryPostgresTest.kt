...
/**
 * PostgreSQL-specific tests for ListenerEventRepository.
 * Uses Testcontainers to spin up a PostgreSQL instance.
 */
@RequiresDocker
@DisplayName("ListenerEventRepository [PostgreSQL]")
class ListenerEventRepositoryPostgresTest : ListenerEventRepositoryTestBase() {
