...
import com.lemline.runner.analytics.config.AnalyticsConfigConstants.LIFECYCLEEVENTS_IN_CHANNEL
...
@Startup
@ApplicationScoped
@IfBuildProperty(name = ANALYTICS_CONSUMER_ENABLED, stringValue = "true")
internal class LifecycleAnalyticsSubscriber(
    @param:ConfigProperty(
        name = ANALYTICS_CONSUMER_CONCURRENCY,
