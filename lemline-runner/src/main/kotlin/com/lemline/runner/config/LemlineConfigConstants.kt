...
object LemlineConfigConstants {
    ...
    const val POSTGRES_USER_DEFAULT = "postgres"
    ...
    const val MYSQL_USER_DEFAULT = "mysql"
    ...
    const val RABBITMQ_QUEUE_DEFAULT = "lemline"
    const val RABBITMQ_STRING_SERIALIZER = "java.lang.String"

    // Metrics
    const val METRICS_PORT_DEFAULT = "lemline"
