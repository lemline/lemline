...
internal val LemlineConfiguration.gatewayEnabled: Boolean
    get() = gateway().getOrNull()?.enabled() ?: LemlineConfigConstants.GATEWAY_ENABLED_DEFAULT.toBoolean()

internal val LemlineConfiguration.gatewayAuthenticationEnabled: Boolean
...
internal val LemlineConfiguration.gatewayAuthenticationScopeField: String
...
internal val LemlineConfiguration.gatewayAuthenticationNamespacesField: String
