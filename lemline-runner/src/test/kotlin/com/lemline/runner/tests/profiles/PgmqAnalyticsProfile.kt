...
class PgmqAnalyticsProfile : QuarkusTestProfile {
    override fun getConfigOverrides(): Map<String, String> {
        return mapOf(
            com.lemline.runner.common.config.LEMLINE_DATABASE_TYPE to DatabaseType.POSTGRESQL.configValue,
            ...
            com.lemline.runner.common.config.LEMLINE_MESSAGING_PGMQ_LIFECYCLE_EVENTS_QUEUE to "lemline-lifecycle-analytics-pgmq",
