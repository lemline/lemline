...
/**
 * Runs the ListenerEventRepositoryTest suite against a PostgreSQL database.
 */
@QuarkusTest
...
internal class PostgresListenerEventRepositoryTest : ListenerEventRepositoryTest()
