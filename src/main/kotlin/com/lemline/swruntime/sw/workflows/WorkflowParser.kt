...
class WorkflowParser(
    ...
    internal fun Workflow.parseNodes() {
        ...
        // Initialize cache
        nodesCache[index] = mutableMapOf<com.lemline.swruntime.sw.tasks.JsonPointer, NodeTask<*>>().apply {
    ...
    companion object {
        ...
        internal val nodesCache =
            ConcurrentHashMap<WorkflowIndex, Map<com.lemline.swruntime.sw.tasks.JsonPointer, NodeTask<*>>>()
    }
}
