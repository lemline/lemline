...
@ApplicationScoped
class WaitMessageOutbox(
    private val repository: WaitMessageRepository,
    ...
    private fun processMessage(waitMessage: WaitMessage) {
            ...
            while (true) {
                ...
                for (message in messages) {
                    try {
                        ...
                        message.status = WaitMessage.MessageStatus.SENT
                        ...
                        if (message.attemptCount >= retryMaxAttempts) {
                            message.status = WaitMessage.MessageStatus.FAILED
        ...
        try {
            ...
            while (true) {
                ...
                val messagesToDelete =
                    repository.findAndLockForDeletion(cutoffDate, cleanupBatchSize)
