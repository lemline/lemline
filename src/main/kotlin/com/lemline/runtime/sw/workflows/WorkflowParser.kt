...
import com.lemline.runtime.sw.tasks.NodePosition
import com.lemline.runtime.sw.tasks.NodeTask
import com.lemline.runtime.sw.tasks.RootTask
import com.lemline.runtime.system.System
...
class WorkflowParser(
    ...
    internal fun Workflow.parseNodes() {
        ...
        // Initialize cache
        nodesCache[index] = mutableMapOf<com.lemline.runtime.sw.tasks.JsonPointer, NodeTask<*>>().apply {
    ...
    companion object {
        ...
        internal val nodesCache =
            ConcurrentHashMap<WorkflowIndex, Map<com.lemline.runtime.sw.tasks.JsonPointer, NodeTask<*>>>()
    }
}
