package com.lemline.runtime.sw.workflows

import com.fasterxml.jackson.databind.JsonNode
import com.lemline.runtime.logger
import com.lemline.runtime.messaging.WorkflowMessage
import com.lemline.runtime.sw.errors.CaughtDoWorkflowException
import com.lemline.runtime.sw.expressions.scopes.RuntimeDescriptor
import com.lemline.runtime.sw.expressions.scopes.WorkflowDescriptor
import com.lemline.runtime.sw.tasks.*
import com.lemline.runtime.sw.tasks.activities.*
import com.lemline.runtime.sw.tasks.flows.*
...
class WorkflowInstance(
    ...
    private fun NodeTask<*>.createInstance(parent: NodeInstance<*>?): NodeInstance<*> = when (task) {
        ...
        is RaiseTask -> com.lemline.runtime.sw.tasks.flows.RaiseInstance(this as NodeTask<RaiseTask>, parent!!)
        is SetTask -> SetInstance(this as NodeTask<SetTask>, parent!!)
        is SwitchTask -> com.lemline.runtime.sw.tasks.flows.SwitchInstance(this as NodeTask<SwitchTask>, parent!!)
        ...
        is RunTask -> com.lemline.runtime.sw.tasks.activities.RunInstance(this as NodeTask<RunTask>, parent!!)
        is WaitTask -> com.lemline.runtime.sw.tasks.activities.WaitInstance(this as NodeTask<WaitTask>, parent!!)
