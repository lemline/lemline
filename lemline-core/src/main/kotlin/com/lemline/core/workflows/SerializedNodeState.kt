...
/**
 * Represents a node's serialized state for persistence.
 * Contains state variables for the task during execution that need to be persisted.
...
@ExperimentalTime
@Serializable
data class SerializedNodeState(
