...
//        val output = CompleteOrchestrator.resumeFromTask(rootNode, JsonObject(mapOf()))
//
...
//        """
//        val rootNode = getWorkflowNode(doYaml)
//        val output = CompleteOrchestrator.resumeFromTask(rootNode, JsonPrimitive(1))
//
//        // Assert the output matches our expected transformed value
//        assertEquals(
...
//        """
//        val rootNode = getWorkflowNode(doYaml)
//        val output = CompleteOrchestrator.resumeFromTask(rootNode, JsonPrimitive(1)) as JsonObject
//
//        // Assert the output matches our expected transformed value
...
//        """
//        val rootNode = getWorkflowNode(doYaml)
//        val output = CompleteOrchestrator.resumeFromTask(rootNode, JsonPrimitive(""))
//
//        // Assert the output matches our expected transformed value
//        assertEquals(
