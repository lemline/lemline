...
//        val output = CompleteOrchestrator.resumeFromTask(rootNode, JsonObject(mapOf())) as JsonObject
//
...
//        val rootNode = getWorkflowNode(workflowYaml)
//
//        assertThrows<InternalWorkflowException> {
//            CompleteOrchestrator.resumeFromTask(rootNode, JsonObject(mapOf()))
//        }
//    }
//
//    @Test
...
//
//        assertThrows<InternalWorkflowException> {
//            CompleteOrchestrator.resumeFromTask(rootNode, JsonObject(mapOf("firstName" to JsonPrimitive("Gilles"))))
//        }
//    }
//
//    @Test
...
//        val rootNode = getWorkflowNode(workflowYaml)
//        val output =
//            CompleteOrchestrator.resumeFromTask(
//                rootNode,
//                JsonObject(mapOf("firstName" to JsonPrimitive("Gilles")))
//            ) as JsonObject
//
//        assertEquals(JsonPrimitive(true), output["caught"])
//    }
